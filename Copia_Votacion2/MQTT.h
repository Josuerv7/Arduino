...
#define HOTSPOT_WIFI  "iPhone de Nereo"            /* Nombre del punto de acceso a conectarse */
...
#define TXTOPIC       "/iot/votaciones/test"         /* Nombre del topic de publicación */
#define RXTOPIC       "/Esli"         /* Nombre del topic de suscripción */
#define RXTOPIC1      "/Esli"      /* Nombre del topic de suscripción */
...
void MQTT :: publish_MQTT ( String msg) {
  ...
  client.publish( TXTOPIC, msg.c_str());                 /* Función librería PubsubClient */
