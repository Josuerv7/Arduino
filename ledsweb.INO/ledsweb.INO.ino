...
void loop() {
  ...
  // St LED according to the request
  digitalWrite(LED_BUILTIN, val);

int val2;
  if (req.indexOf(F("/gpio3/")) != -1) {
    val2 = 0;
  ...
  client.print(F("<br><br>Click <a href='http://"));
client.print(WiFi.localIP());
client.print(F("/gpio/3'>aquí</a> para apagar el Led, o <a href='http://"));
client.print(WiFi.localIP());
client.print(F("/gpio/2'>aquí</a> para encender el Led Externo</html>"));
